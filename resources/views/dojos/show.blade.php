...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-8">
        <div class="col-span-12 lg:col-span-8">
            <h1 class="font-bold text-2xl my-4 text-center lg:text-left">{{ $dojo->name }}</h1>
            <!-- Image Slide -->
            <div>
                @if (!empty($images))
                        ...
                        <div id="jssor_1" class="relative mx-auto w-full lg:h-lg h-60 overflow-hidden">
                            ...
                            <div data-u="navigator" class="jssorb072 absolute bottom-7"
                                ...
                                <div data-u="prototype" class="i">
                                    <div data-u="numbertemplate"
                                         class="n text-xs bg-white bg-opacity-60 backdrop-filter backdrop-blur-sm mx-1 rounded-full p-1 px-2"></div>
                                </div>
                            </div>
                            ...
                            <div data-u="arrowleft" class="jssora073 transform-none" data-autocenter="2" data-scale="0.75"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor"
                                     class="absolute backdrop-blur-sm backdrop-filter bg-opacity-30 bg-white h-6 p-1 left-10 rounded-full top-1/2 w-6">
                            ...
                            <div data-u="arrowright" class="jssora073 transform-none" data-autocenter="2" data-scale="0.75"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor"
                                     class="absolute backdrop-blur-sm backdrop-filter bg-opacity-30 bg-white h-6 p-1 right-10 rounded-full top-1/2 w-6">
                ...
                <table class="items-center w-full border-collapse">
                    ...
                    <tr>
                        ...
                        <td class="align-middle border p-4">
                            {{ $dojo->address }}
                        </td>
                    </tr>
                    <tr>

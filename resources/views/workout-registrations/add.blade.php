...
<div class="archive-post-area">
    <div class="container-fluid">
        <div class="row">
            ...
            <form class ="col-md-8" action="{{ route('workout-registrations.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input type="text" name="name" id="input-name" class="form-control pl-2"
                                            placeholder="Tên" value="{{ old('name')}}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white bg-red border-success"><i
                                                    class="fa fa-transgender" aria-hidden="true"></i></span>
                                        </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input type="text" name="cmnd" id="input-cmnd" class="form-control pl-2"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input type="text" name="phone" id="input-phone" class="form-control pl-2"
                            ...
                            <div class="col-md-6 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white bg-red border-success"><i
                                                    class="fa fa-child" aria-hidden="true"></i></span>
                                        </div>
                                        <input id="input-height" name="height" class="form-control pl-2"
                                            value="{{ old('height')}}" type="number" pattern="[0-9]{10}" min="100" max="200"
                                            step="1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white bg-red border-success"><i
                                                    class="fa fa-dashboard" aria-hidden="true"></i></span>
                                        </div>
                                        <input id="input-weight" name="weight" class="form-control pl-2"
                                            value="{{ old('weight')}}" type="number" pattern="[0-9]{10}" min="20" max="120"
                                            step="0.1" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="input-address" name="address" class="form-control pl-2"
                                            placeholder="Địa chỉ" value="{{ old('address')}}" type="text" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input type="text" name="work_unit" id="input-work-unit" class="form-control pl-2"
                                            placeholder="Nơi làm việc" value="{{ old('Nơi làm việc')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input id="input-fb" name="link_fb" class="form-control pl-2"
                                            placeholder="Link Facebook" value="{{ old('link_facebook')}}" type="text"
                                            required>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-2">
                <img src="/img/core-img/backdrop1.png" alt="tuyensinh.png" style="width:100%; height:auto;">
            </div>
        </div>
        ...
        <ins class="adsbygoogle" style="display:inline-block;width:100%;height:200px"
            data-ad-client="ca-pub-1747924550904432" data-ad-slot="9889684921"></ins>
        <script>

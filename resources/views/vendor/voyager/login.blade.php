    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="intro-logo">
                ...
                <p>HỆ THỐNG VÕ THUẬT LEAGUE DOJO</p>
            </div>
            ...
            <div class="login-container">
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group" id="rememberMeGroup">
                        <div class="controls">
                        <input type="checkbox" name="remember" id="remember" value="1"><label for="remember" class="remember-me-text">Duy trì đăng nhập</label>
                        </div>
                    </div>

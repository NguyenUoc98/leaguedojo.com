                ...
                <div class="col-md-8">
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <textarea class="form-control" name="excerpt" rows="7">{{ $dataTypeContent->excerpt ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'source',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'source')
                                ])
                                <input type="text" class="form-control" id="source" name="source" placeholder="Nguồn" value="{{ $dataTypeContent->source ?? '' }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                @endphp
                                <div class="add-field">
                                    <div class="clonedInput" id="keyword_1">
                                        <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="confirm_delete">{{ __('voyager::generic.delete_confirm') }}
                    </button>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        function createClone() {
            axios.post("{{ route('posts.clone-fields') }}", {
                divCount: ++divCount,
            })
            .then(response => {

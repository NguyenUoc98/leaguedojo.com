...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="{{ route('videos.sync') }}" class="btn btn-info btn-add-new" id="sync">
                    <i class="voyager-youtube-play"></i> <span>Đồng bộ</span>
            </a>
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover" style="font-size:14px">
                                <thead>
                                    <tr>

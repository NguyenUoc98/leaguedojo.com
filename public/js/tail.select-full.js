...
;(function(root, factory){
    ...
    select.strings = {
        ...
        vi: {
            all: "Tất cả",
            none: "Trống",
            empty: "Không có giá trị có sẵn",
            emptySearch: "Không tìm thấy giá trị",
            limit: "Bạn không thể chọn thêm",
            placeholder: "Chọn các giá trị...",
            placeholderMulti: "Chọn tối đa :limit giá trị...",
            search: "Nhập để tìm kiếm...",
            disabled: "Trường này bị vô hiệu hóa"
        },
        es: {
            all: "Todos",
            none: "Ninguno",

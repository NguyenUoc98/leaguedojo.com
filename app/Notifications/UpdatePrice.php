...
class UpdatePrice extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        $mailMessage = (new MailMessage)
            ...
            ->line(Lang::get('Ban quản lý cơ sở ' . $this->dojoName . ' đã quyết định thay đổi mức học phí từ ' . number_format($this->priceOld,
                    0, '', '.') . 'VNĐ/tháng thành ' . number_format($this->priceNew, 0, '', '.') . 'VNĐ/tháng.'))

...
class DojoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dojos.index', compact('dojos', 'meta_desc', 'meta_keywords', 'url_canonical', 'image_og', 'meta_title'));
    }
    ...
    public function show($slug)
    {
        ...
        return view('dojos.show', compact('dojo', 'otherDojos', 'policy', 'meta_desc', 'meta_keywords', 'url_canonical', 'image_og', 'meta_title'));
    }
}
